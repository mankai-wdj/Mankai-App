...
public class PapagoTranslate {
        ...
        public static String getTranslation(String word, String source, String target) {
            ...
            new Thread() {
                public void run(){
                    try {
                        ...
                        String message = jsonObject.getJSONObject("message").getJSONObject("result").getString("translatedText");
                        cnt = message;
